  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .loading-overlay {
      ...
      place-items: center;
      background:
        radial-gradient(circle at center, rgba(47, 230, 255, .18), transparent 32%),
        rgba(1, 5, 9, .84);
      backdrop-filter: blur(14px);
    }
    ...
    .loader-card {
      ...
      padding: 28px;
      text-align: center;
      background: rgba(9, 22, 34, .86);
      box-shadow: 0 0 52px rgba(47, 230, 255, .18);
    }
    ...
    .loader-ring {
      ...
      box-shadow: 0 0 28px rgba(47, 230, 255, .24);
    }
...
<body>
  ...
  <section class="loading-overlay" id="loadingOverlay" aria-hidden="true">
    <div class="loader-card">
      ...
      <span>DGA, BDV, OTI and WTI signals are being processed...</span>
    </div>
  </section>
